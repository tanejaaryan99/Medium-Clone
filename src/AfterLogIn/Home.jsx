...
export const Home = () => {
  ...
  React.useEffect(() => {
    ...
    fetch(`https://mediumserver.herokuapp.com/newslist/all`)
  ...
  return isloading ? (
    ...
    <>
      <Div>
        ...
        <hr className={styles.hrli13} />

        {ldata.map((eblog, idx) =>
          eblog.image == null ? null : (
            <div key={idx * 100} className={styles.ll2h}>
              <div className="lett">
              ...
              <div className={styles.ll8h}>
                {" "}
                <img src={eblog.image} alt="" />
              </div>
              <hr className={styles.hrlin13} />
            </div>
          )
        )}
        {adata.map((eblog, idx) => (
          <div key={idx * 2000}>
            <div className={styles.ll2h}>
